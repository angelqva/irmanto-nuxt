			...
			<div class="col-12">
				<nav class="navbar navbar-expand-lg blur border-radius-sm top-0 z-index-3 shadow position-absolute my-3 py-2 start-0 end-0 mx-4">
					<div class="container-fluid px-1">
						<NuxtLink to="/" class="navbar-brand font-weight-bolder ms-lg-0"> Irmantto MyPyMe </NuxtLink>
						<button
							ref="toggleMenu"
						...
						<div class="collapse navbar-collapse" id="navigation">
							<ul class="navbar-nav mx-auto ms-xl-auto">
								<li class="nav-item">
									<NuxtLink :class="classLink" to="/dashboard">
										<i class="fa fa-dashboard pe-2"></i>
										Dashboard
									</NuxtLink>
								</li>
								<li class="nav-item">
									<NuxtLink :class="classLink" to="/registrarse">
										<i class="fa fa-address-card pe-2"></i>
										Registrarse
									</NuxtLink>
								</li>
								<li class="nav-item">
									<NuxtLink :class="classLink" to="/autenticarse">
							...
							<ul class="navbar-nav d-lg-block d-none">
								<li class="nav-item">
									<NuxtLink to="/" class="btn btn-sm mb-0 bg-gradient-dark"> Accion a Realizar </NuxtLink>
								</li>
							</ul>
						</div>
					</div>
...
<script lang="ts" setup>
	const classLink: string = "nav-link d-flex align-items-center me-2 p-3 p-md-2";
