			...
			<div class="col-12 col-sm-6 col-md-4 mb-8">
				<div class="card">
					<div class="card-header pb-0">
						...
						<p class="text-center fs-5 mb-0">Descripcion del formulario</p>
					</div>
					<div class="card-body">
						<div class="mx-md-5 mx-2">
							...
							<FormSelect
								...
								v-model:errorBackend="data.opciones.errorBackend"
							...
							<FormAreaText
								...
								v-model:errorBackend="data.textarea.errorBackend"
							...
							/>
							<FormCheck :label="data.check.label" v-model="data.check.value" v-model:error-backend="data.check.errorBackend" v-model:valido="data.check.valido" />
							<button @click="clog" class="btn btn-dark w-100 mt-3 mb-3">Console Log</button>
						</div>
					</div>
				</div>
			</div>
